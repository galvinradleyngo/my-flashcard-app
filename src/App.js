...
const flashcardData = [
    {
        ...
        studentInteractions: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To learn new animal vocabulary words']. **Action**: Tell me a story. **Purpose**: To help me learn about [ANIMAL_TYPE/THEME] and **expand my vocabulary**. **Expectation**: The story should be short and have pictures. GenAI will occasionally introduce one new word slightly above my current level and explain it with simple context to gently expand my vocabulary."
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To understand how plants make food']. **Action**: Explain [CONCEPT_NAME] to me. **Purpose**: To help me understand it easily and **practice active recall**. **Expectation**: Explain it like I'm in [GRADE_LEVEL], using simple words and giving [NUMBER] examples related to [TOPIC]. After the explanation, GenAI will ask me [NUMBER] questions that require me to remember key details without looking back immediately, prompting my thinking."
            },
            grade7_10: {
    ...
    },
    {
        ...
        teacherActivities: {
            ...
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve data analysis and evaluation in my 7th-10th graders']. **Action**: Generate hypothetical scenarios. **Purpose**: To help 7th-10th graders analyze [TOPIC_AREA_E.G._POPULATION_TRENDS] and **develop critical evaluation skills**. **Expectation**: Create [NUMBER] detailed scenarios, each with a small dataset or set of variables. Include questions that require students to analyze trends and make predictions. GenAI will present slightly contradictory 'expert' opinions in a scenario to encourage critical source evaluation and deeper thinking."
            },
            grade11_12: {
        ...
        studentInteractions: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To understand why things happen in nature']. **Action**: Ask me 'why' questions about observations. **Purpose**: To help me think about [SIMPLE_OBSERVATION, E.G._WHY_DO_LEAVES_FALL]. **Expectation**: GenAI will ask me [NUMBER] 'why' questions about common things I see, and then provide a simple answer after I try, guiding my causal thinking."
            },
            grade4_6: {
            ...
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To refine my research questions and identify logical fallacies']. **Action**: Refine my research question. **Purpose**: To make my capstone project question on [BROAD_TOPIC] more focused and academic and **to identify logical fallacies**. **Expectation**: GenAI will review my current question: '[YOUR_CURRENT_QUESTION]'. It will suggest [NUMBER] ways to narrow its scope, add academic rigor, and make it more suitable for a [TYPE_OF_PROJECT_E.G._DISSERTATION]. In our simulated debate, GenAI will introduce [NUMBER] arguments that contain a common logical fallacy for me to identify and refute, enhancing my critical thinking skills."
            }
        },
    ...
    },
    {
        ...
        teacherActivities: {
            ...
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve critical reasoning and discussion in my 7th-10th graders']. **Action**: Generate detailed personas for role-playing discussion. **Purpose**: To facilitate a rich discussion among 7th-10th graders on [CONTROVERSIAL_TOPIC] and **hone critical reasoning**. **Expectation**: Create [NUMBER] personas with distinct viewpoints. In one persona's talking points, GenAI will include a common misconception related to the topic, prompting students to identify and politely correct it during the discussion, fostering deeper engagement."
            },
            grade11_12: {
        ...
        studentInteractions: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve my storytelling skills']. **Action**: Tell me a story. **Purpose**: To help me practice telling stories. **Expectation**: Tell me a short story about [TOPIC]. Then, GenAI will ask me to tell it back in my own words and provide feedback on how well I remembered the main parts, encouraging active recall."
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To practice arguing politely']. **Action**: Have a simple debate with me. **Purpose**: To practice my arguing skills about [FAVORITE_ANIMAL/TOPIC] and **justify my reasoning**. **Expectation**: GenAI will argue against my choice, giving me [NUMBER] reasons why [OPPOSITE_VIEW] is better. After I give my response, GenAI will ask 'Why do you think that?' or 'Can you give me an example?' to encourage deeper justification."
            },
            grade7_10: {
    ...
    },
    {
        ...
        studentInteractions: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To get better at counting']. **Action**: Give me a counting game. **Purpose**: To help me practice counting to [NUMBER] and **build counting flexibility**. **Expectation**: GenAI will provide a fun game where I count [OBJECTS] and it tells me if I'm right. Occasionally, GenAI will ask me to count backwards from [NUMBER] or skip count by [NUMBER] to build counting flexibility."
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve my division skills']. **Action**: Give me [NUMBER] math problems. **Purpose**: To practice [MATH_SKILL, E.G._LONG_DIVISION] and **develop conceptual understanding**. **Expectation**: GenAI will provide problems suitable for a [GRADE_LEVEL] student. After each problem, it will tell me if my answer is correct and explain how to solve it if I get it wrong. GenAI will also include problems where the missing number is not always the answer (e.g., '5 + ? = 10') to encourage deeper understanding."
            },
            grade7_10: {
    ...
    },
    {
        ...
        studentInteractions: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To create imaginative drawings']. **Action**: Give me ideas for my drawing. **Purpose**: To help me draw a [OBJECT/ANIMAL] and **encourage elaboration**. **Expectation**: GenAI will suggest [NUMBER] different ways to draw a [OBJECT/ANIMAL] and include ideas for [COLORS]. After I tell GenAI what I drew, it will ask me 'What else could you add to make it even more interesting?' to prompt further creative thinking."
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To write more creative stories']. **Action**: Brainstorm ideas for a creative writing piece. **Purpose**: To help me start writing a story about [GENRE_E.G._FANTASY] and **integrate diverse concepts**. **Expectation**: GenAI will suggest [NUMBER] plot ideas, [NUMBER] character ideas, and [NUMBER] setting ideas. It will then prompt me to combine two distinct ideas (e.g., a [IDEA_1] and a [IDEA_2]) into a single cohesive paragraph, enhancing my synthesis skills."
            },
            grade7_10: {
            ...
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To write a high-quality academic paper']. **Action**: Provide sophisticated guidance on argumentative structures. **Purpose**: To refine the argumentative flow of my [TYPE_OF_PAPER_E.G._RESEARCH_PAPER] on [TOPIC] and **evaluate design trade-offs**. **Expectation**: GenAI will analyze my current argumentative structure and suggest alternative structures, explaining their strengths and weaknesses. It will also provide feedback on my design choices, requiring me to explain the *trade-offs* of different approaches, enhancing my critical evaluation and problem-solving skills."
            }
        },
    ...
    },
    {
        ...
        studentInteractions: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To learn to play well with others']. **Action**: Give me ideas for playing together. **Purpose**: To help me and my friends play nicely and **understand the value of collaboration**. **Expectation**: GenAI will suggest [NUMBER] simple games or activities that we can all do together. After we finish, GenAI will prompt me to articulate *why* sharing was important in that game, encouraging reflection on collaborative value."
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To brainstorm ideas for our group project']. **Action**: Act as a shared brainstorming tool. **Purpose**: To help our team generate ideas for our [GROUP_PROJECT_TYPE_E.G._MODEL_VOLCANO] and **develop critical evaluation of ideas**. **Expectation**: GenAI will ask us questions to get our ideas, then summarize our suggestions. After brainstorming, GenAI will ask us to identify the *single strongest* idea generated and explain our reasoning, fostering critical evaluation of collective thinking."
            },
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve team problem-solving']. **Action**: Act as a resource for collective problem-solving. **Purpose**: To help our team approach the challenge of [TEAM_CHALLENGE] and **practice strategic compromise**. **Expectation**: GenAI will ask us about our current ideas and suggest different strategies. It will then present two equally plausible but mutually exclusive solutions to a sub-problem, asking the group to justify their chosen compromise and highlighting the trade-offs, guiding strategic decision-making."
            },
            grade11_12: {
                    ...
                    <div className="flashcard-face flashcard-back flex flex-col overflow-y-auto p-6 sm:p-8">
                        ...
                        <div className="mb-4">
                            ...
                            <button
                                ...
                                style={{ backgroundColor: 'white', color: 'black', fontSize: '18px', fontWeight: 'bold' }} // Inline styles for debugging
                            >
                                <Lightbulb className="w-5 h-5 mr-1" style={{ color: 'black' }} /> {/* Inline style for icon */}
                                Get Prompt
                            </button>
                        </div>
                        <div className="mb-4">
