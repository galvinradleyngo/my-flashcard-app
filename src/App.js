...
const flashcardData = [
    {
        ...
        teacherActivities: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To help my Pre-K to 3rd graders recognize sight words'].\n\n**Action**: Generate a simple story with repetitive elements.\n\n**GenAI will ask**: \n1. What new vocabulary word(s) should the story focus on?\n2. What is the topic of the story?\n3. What type of character(s) should be featured?\n4. How many sentences long should the story be?\n5. How many simple retrieval questions should be included about the story's events? (The repetitive phrase will be highlighted automatically.)"
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To help my 4th-6th graders understand basic scientific processes'].\n\n**Action**: Summarize a historical event.\n\n**GenAI will ask**: \n1. What historical event should the summary focus on?\n2. What are the key points that should be covered?\n3. Approximately how many paragraphs should the summary be?\n4. How many multiple-choice quiz questions with image suggestions should be included, and how often should they appear within the summary (e.g., every 2 paragraphs)?"
            },
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To enhance my 7th-10th graders' ability to synthesize information from complex texts'].\n\n**Action**: Generate a concise summary.\n\n**GenAI will ask**: \n1. What scientific article or literary text should the summary be based on?\n2. What is the main argument or key findings that should be highlighted?\n3. How many words should the summary be (maximum)?\n4. How many different versions of the summary would you like (e.g., bulleted, narrative, concept map outline)?\n5. How many differentiated reading passages should be provided from this summary, and at what reading complexity levels (e.g., beginner, intermediate, advanced)?"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To foster critical evaluation skills in my 11th-12th graders'].\n\n**Action**: Develop a video script for instructional content and a case study.\n\n**GenAI will ask**: \n1. What advanced physics concept or economic theory should the script focus on?\n2. Approximately how long should the video script be (in minutes)?\n3. What sub-topics should be included in the explanation?\n4. How many subtle ambiguities or gaps should be introduced into the related case study to prompt deeper investigation?"
            }
        },
        studentInteractions: {
            preK3: {
            ...
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To prepare for my upcoming science test'].\n\n**Action**: Generate practice questions.\n\n**GenAI will ask**: \n1. What subject and topic is your test on (e.g., Biology, cell structure)?\n2. How many multiple-choice questions would you like?\n3. Are there any specific areas of this topic you want to focus on (e.g., organelles)?\n(GenAI will provide hints and feedback on your thinking, and if incorrect, an alternative explanation.)"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To grasp the nuances of quantum mechanics'].\n\n**Action**: Explain a concept in depth.\n\n**GenAI will ask**: \n1. What abstract concept or theory would you like me to explain (e.g., string theory)?\n2. From what perspectives should I explain it (e.g., a theoretical physicist's view, a practical applications view)?\n3. What fields or implications should I discuss (e.g., cosmology, quantum computing)?\n4. What related concepts should I include for interleaved practice (e.g., general relativity, quantum field theory)?"
            }
        },
    ...
    },
    {
        ...
        teacherActivities: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To encourage my Pre-K to 3rd graders to ask scientific questions'].\n\n**Action**: Generate 'what if' scenarios.\n\n**GenAI will ask**: \n1. What animal habitat should the scenarios focus on (e.g., rainforests)?\n2. How many simple scenarios would you like?\n3. For each scenario, what animal and unusual place should be featured (e.g., 'What if a monkey lived in the ocean?')?"
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To develop research skills in my 4th-6th graders'].\n\n**Action**: Generate open-ended research prompts.\n\n**GenAI will ask**: \n1. What local ecosystem or historical figure should the prompts focus on (e.g., the local river ecosystem)?\n2. How many research prompts would you like?\n(GenAI will include slightly ambiguous initial information in scenarios to encourage clarifying questions.)"
            },
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve data analysis and evaluation in my 7th-10th graders'].\n\n**Action**: Generate hypothetical scenarios.\n\n**GenAI will ask**: \n1. What topic area should the scenarios focus on (e.g., population trends, scientific experiment results)?\n2. How many detailed scenarios would you like, each with a small dataset or set of variables?\n(GenAI will include questions that require students to analyze trends and present slightly contradictory 'expert' opinions to encourage critical source evaluation.)"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To enhance advanced investigative and information filtering skills'].\n\n**Action**: Design an elaborate digital 'cold case' simulation.\n\n**GenAI will ask**: \n1. What historical event or scientific mystery should the simulation focus on (e.g., the disappearance of the Roanoke colony)?\n2. How many key 'clues' (e.g., documents, data snippets) should the narrative include?\n3. How many pieces of irrelevant or distracting information should be introduced to train information filtering?"
            }
        },
        studentInteractions: {
            preK3: {
            ...
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To formulate strong scientific hypotheses for my science fair project'].\n\n**Action**: Generate hypotheses for an experiment.\n\n**GenAI will ask**: \n1. What scientific topic is your experiment on (e.g., plant growth)?\n2. What is the dependent variable (what you are measuring, e.g., plant height)?\n3. What is the independent variable (what you are changing, e.g., amount of light)?\n(After you propose your own hypothesis, GenAI will provide a constructive critique.)"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To refine my research questions and identify logical fallacies'].\n\n**Action**: Refine my research question.\n\n**GenAI will ask**: \n1. What is the broad topic of your capstone project (e.g., the impact of social media on society)?\n2. What is your current research question?\n(GenAI will suggest ways to narrow its scope and add academic rigor. In a simulated debate, GenAI will introduce arguments with logical fallacies for you to identify.)"
            }
        },
    ...
    },
    {
        ...
        teacherActivities: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To foster polite classroom discussions'].\n\n**Action**: Generate simple prompts for 'show and tell'.\n\n**GenAI will ask**: \n1. How many prompts would you like?\n2. What is the main theme or focus of the 'show and tell' (e.g., favorite toy, recent adventure)?\n(GenAI will include follow-up instructions to encourage active listening and response.)"
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To develop respectful debate skills in my 4th-6th graders'].\n\n**Action**: Generate discussion prompts for a classroom debate.\n\n**GenAI will ask**: \n1. What is the debate topic (e.g., whether homework should be banned)?\n2. How many prompts covering both sides of the argument would you like?\n3. How many simple character personas should be created for role-playing, each with a slightly incomplete argument for students to complete?"
            },
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve critical reasoning and discussion in my 7th-10th graders'].\n\n**Action**: Generate detailed personas for role-playing a discussion.\n\n**GenAI will ask**: \n1. What controversial topic should the discussion focus on (e.g., gene editing ethics)?\n2. How many personas with distinct viewpoints would you like?\n(GenAI will include a common misconception in one persona's talking points for students to identify and correct.)"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To prepare my 11th-12th graders for advanced academic discussions'].\n\n**Action**: Generate complex discussion prompts for a Socratic seminar.\n\n**GenAI will ask**: \n1. What philosophical concept or policy implication should the Socratic seminar focus on (e.g., the philosophy of free will)?\n2. How many open-ended questions encouraging nuanced argumentation and critical thinking would you like?\n(GenAI will introduce new data or ethical dilemmas during a simulated discussion to challenge adaptation.)"
            }
        },
        studentInteractions: {
            preK3: {
            ...
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve my debate arguments'].\n\n**Action**: Engage me as a debate partner.\n\n**GenAI will ask**: \n1. What is the debate topic (e.g., climate change policies)?\n2. What is your initial point or argument?\n3. Would you like me to provide different perspectives on a social issue (e.g., gentrification)?\n(GenAI will present counter-arguments and provide feedback on logical gaps.)"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To enhance my critical thinking and argumentation'].\n\n**Action**: Engage me in an advanced debate.\n\n**GenAI will ask**: \n1. What complex ethical issue do you want to debate (e.g., the ethics of AI autonomy)?\n2. What is your initial statement or argument on this topic?\n(GenAI will challenge your statement with nuanced counter-arguments and intentionally flawed arguments for you to identify.)"
            }
        },
    ...
    },
    {
        ...
        teacherActivities: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To help my Pre-K to 3rd graders practice counting numbers'].\n\n**Action**: Generate simple drawing prompts.\n\n**GenAI will ask**: \n1. How many drawing prompts would you like?\n2. What animal or object should be featured, and what color suggestions do you have?\n(GenAI will vary the representation for number matching games to promote flexible application.)"
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To give my 4th-6th graders more math practice'].\n\n**Action**: Create unlimited variations of math problems.\n\n**GenAI will ask**: \n1. What math operation(s) should the problems focus on (e.g., multiplication, mixed operations)?\n2. How many problems with solutions would you like?\n3. Would you like a short role-play scenario for a specific situation (e.g., ordering food)?\n(GenAI will interleave different problem types to encourage flexible thinking.)"
            },
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To prepare my 7th-10th graders for job interviews'].\n\n**Action**: Create realistic scenarios for role-play practice.\n\n**GenAI will ask**: \n1. What type of situation should the role-play focus on (e.g., job interview, customer service)?\n2. How many detailed scenarios, including potential questions and challenges, would you like?\n3. How many common errors should GenAI generate for students to identify and explain?"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To help my 11th-12th graders master calculus concepts'].\n\n**Action**: Design a highly adaptive, personalized learning path.\n\n**GenAI will ask**: \n1. What complex topic should the learning path focus on (e.g., calculus integration, abstract algebra)?\n2. How many modules should the path include?\n3. How many intelligent quiz questions should be generated per module?\n(When you answer incorrectly, GenAI will first ask you to explain your reasoning before providing hints.)"
            }
        },
        studentInteractions: {
            preK3: {
            ...
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To become more fluent in Spanish'].\n\n**Action**: Practice speaking a new language with me.\n\n**GenAI will ask**: \n1. What language would you like to practice (e.g., Spanish)?\n2. What situation should our dialogue focus on (e.g., ordering food, asking for directions)?\n3. How many turns should our dialogue be?\n(GenAI will provide feedback on your grammar and pronunciation and introduce slightly more complex vocabulary as you progress.)"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To write a compelling research paper'].\n\n**Action**: Critique my writing.\n\n**GenAI will ask**: \n1. What type of paper are you working on (e.g., research proposal, essay)?\n2. What is the academic course it's for (e.g., Senior English, Philosophy)?\n3. What specific disciplinary conventions should I consider (e.g., MLA format, APA style)?\n(GenAI will analyze your arguments and style, and when suggesting corrections, it will ask you to explain the underlying principle.)"
            }
        },
    ...
    },
    {
        ...
        teacherActivities: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To spark creativity in my Pre-K to 3rd graders'].\n\n**Action**: Generate ideas for simple art projects.\n\n**GenAI will ask**: \n1. How many art project ideas would you like?\n2. What theme should the projects relate to (e.g., Spring, farm animals)?\n(GenAI will suggest projects that use common materials and encourage combining unrelated elements.)"
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To help my 4th-6th graders write structured reports'].\n\n**Action**: Generate an outline for a report.\n\n**GenAI will ask**: \n1. What type of report are your students writing (e.g., book report, science project outline)?\n2. How many main sections should the outline include?\n3. Would you like example structures for different text types (e.g., persuasive letters), and for what topic?"
            },
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve essay writing and rhetorical awareness'].\n\n**Action**: Generate an outline for an argumentative essay.\n\n**GenAI will ask**: \n1. What is the essay topic?\n2. How many body paragraphs should the outline include (with introduction and conclusion)?\n3. Would you like a starter code snippet for a simple programming task (e.g., Python function), and for what topic?\n(GenAI will provide feedback on drafts asking students to justify stylistic choices.)"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To develop strong thesis proposals and adapt arguments'].\n\n**Action**: Generate a detailed outline for a thesis proposal.\n\n**GenAI will ask**: \n1. What is the thesis topic?\n2. What type of academic assignment is it (e.g., scientific lab report, business plan)?\n3. Would you like typical architectural patterns for a software project, and if so, for what kind of project?\n(GenAI will provide feedback that challenges students to reframe their argument for different audiences.)"
            }
        },
        studentInteractions: {
            preK3: {
            ...
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve my essay structure and grammar'].\n\n**Action**: Get help with structuring my writing.\n\n**GenAI will ask**: \n1. What type of essay or writing piece are you working on (e.g., argumentative essay, research paper)?\n2. What is the main topic of your writing (e.g., environmental conservation)?\n(GenAI will help you generate an outline and provide suggestions for improving your writing style. If you make a grammatical error, GenAI will ask you to identify the root cause before providing the correction.)"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To write a high-quality academic paper'].\n\n**Action**: Get sophisticated guidance on argumentative structures.\n\n**GenAI will ask**: \n1. What type of paper or project are you working on (e.g., research paper, capstone project)?\n2. What is the main topic (e.g., artificial intelligence ethics)?\n(GenAI will analyze your current argumentative structure, suggest alternatives, and provide feedback on your design choices, asking you to explain the trade-offs of different approaches.)"
            }
        },
    ...
    },
    {
        ...
        teacherActivities: {
            preK3: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To encourage my Pre-K to 3rd graders to share and cooperate'].\n\n**Action**: Suggest simple group activities.\n\n**GenAI will ask**: \n1. What kind of class activity should the group activities be for?\n2. How many ideas for activities would you like, focusing on sharing and simple decision-making?\n3. What criteria should GenAI use for initially grouping students, and what different criteria for re-grouping (e.g., favorite color then shoe color)?"
            },
            grade4_6: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To help my 4th-6th graders work together effectively'].\n\n**Action**: Facilitate brainstorming session ideas for a group project.\n\n**GenAI will ask**: \n1. What is the topic of the group project (e.g., a class play, a science presentation)?\n2. How many diverse project ideas would you like?\n3. How many roles (e.g., researcher, presenter, artist) should GenAI suggest for group members?\n4. Would you like a simple template for a collaborative group story, and if so, what theme?"
            },
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To improve group problem-solving for my 7th-10th graders'].\n\n**Action**: Design a complex problem for collaborative solving.\n\n**GenAI will ask**: \n1. What subject area should the problem be from (e.g., environmental science, historical analysis)?\n2. What disciplines should the problem require combining knowledge from (e.g., biology and chemistry)?\n3. How many roles should GenAI suggest for group members?"
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To engage my 11th-12th graders in complex, real-world challenges'].\n\n**Action**: Design a wicked problem for authentic collaboration.\n\n**GenAI will ask**: \n1. What global issue or grand challenge should the problem relate to (e.g., designing a sustainable city, addressing food insecurity)?\n2. How many specialized roles should GenAI dynamically suggest based on team strengths?\n(GenAI will introduce external constraints or resource changes during the project to foster strategic adaptation.)"
            }
        },
        studentInteractions: {
            preK3: {
            ...
            grade7_10: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To brainstorm ideas for our group project'].\n\n**Action**: Act as a shared brainstorming tool.\n\n**GenAI will ask**: \n1. What type of group project are you working on (e.g., a renewable energy project, a historical presentation)?\n2. After brainstorming, GenAI will ask you to identify the *single strongest* idea generated and explain your reasoning."
            },
            grade11_12: {
                ...
                prompt: "**My Learning Goal is**: [Clearly state your learning objective, e.g., 'To develop innovative solutions for global issues'].\n\n**Action**: Act as a sophisticated collaborative brainstorming partner.\n\n**GenAI will ask**: \n1. What complex team challenge are you facing (e.g., designing a sustainable city, optimizing a supply chain)?\n2. After you propose a solution, GenAI will simulate a 'devil's advocate' role, presenting strong counter-arguments for you to refine and justify your solution."
            }
        },
